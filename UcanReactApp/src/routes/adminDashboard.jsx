...
export default function AdminDashboard() {
  ...
  const stats = useMemo(() => {
    return {
      ...
      institutes: new Set(messages.map((message) => message.institute).filter(Boolean)).size,
    };
  }, [messages]);
          ...
          <div className="grid items-center gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-base leading-7 text-[#f4e8d6] sm:text-lg sm:leading-8">
                ...
                and manage the next stage of platform administration.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="grid grid-cols-3 gap-3 text-center">
              ...
              <div className="rounded-2xl bg-[rgba(244,232,214,0.42)] px-3 py-3">
                ...
                <p className="mt-2 text-xl font-bold text-[var(--oman-ink)]">{stats.institutes}</p>
              </div>
            </div>
          </div>
